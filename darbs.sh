#!/bin/sh
# Luke's Auto Rice Boostrapping Script (LARBS) - Dominick's edition :) (DARBS)
# by Luke Smith <luke@lukesmith.xyz> - dominickveil@gmail.com
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/DominickVale/voidrice"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Dominick's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop ON TOP OF MANJARO , which I use as my main machine.\\n\\n-Dominick" 10 60
...
for x in curl base-devel git ntp zsh; do
	dialog --title "DARBS Installation" --infobox "Installing \`$x\` which is required to install and configure other programs." 5 70
	installpkg "$x"
done

dialog --title "DARBS Installation" --infobox "Synchronizing system time to ensure successful and secure installation of software..." 4 70
